...
public:
     ...
     */
    std::shared_ptr<ResultTable> evaluateQuery(PKBReaderManager& pkbReaderManager, const ParsingResult& parsingResult, const Clause& clause, std::shared_ptr<ResultTable>& resultTable) override;
     ...
     * @param parsingResult The parsing result containing the details of the query.
     */
    std::unordered_set<std::string> processParam(Token param, const ParsingResult& parsingResult, PKBReaderManager& pkbReaderManager, std::shared_ptr<ResultTable>& resultTable);
