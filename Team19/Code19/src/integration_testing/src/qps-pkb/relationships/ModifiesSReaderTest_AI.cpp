...
TEST_CASE("qps/QueryProcessingSubsystem: ModifiesSReader Integration Test") {
    ...
    SECTION("Verify ModifiesS relationships via QPS") {
        ...
        auto results2 = Utils::getResultsFromQuery(query2, pkbReaderManager, pkbCacheManager);
    ...
    SECTION("Verify non-existent ModifiesS relationships via QPS") {
        ...
        auto resultsNonExistent = Utils::getResultsFromQuery(queryNonExistent, pkbReaderManager, pkbCacheManager);
    ...
    SECTION("Test ModifiesS with multiple statements and variables via QPS") {
        ...
        auto resultsAll = Utils::getResultsFromQuery(queryAll, pkbReaderManager, pkbCacheManager);
