...
TEST_CASE("src/qps/TestTokenizer") {
    SECTION("Modifies with valid statement and variable") {
    ...
    SECTION("Pattern with variable and constant") {
    ...
    SECTION("quoted constant with wildcards") {
    ...
    SECTION("Check unconventional naming tokenization") {
    ...
    SECTION("Check unconventional naming tokenization 2") {
    ...
    SECTION("Check unconventional naming tokenization 3") {
    ...
    SECTION("Check unconventional naming tokenization 4") {
    ...
    SECTION("Check Tokenisation of quotedconstant >= 10") {
    ...
    SECTION("Check if Tokenisation of quotedconstant < 10 is correct") {
    ...
    SECTION("Check if Tokenisation of 2 clauses is correct") {
    ...
    SECTION("Check if Tokenisation of quouted identifier for long names is correct") {
