...
//using namespace std;
//
//TEST_CASE("src/qps/parser/SelectStatements") {
...
//        std::shared_ptr<AssignPatternWriter> assignPatternWriter = pkbWriterManager->getAssignPatternWriter();
//        std:
//        shared_ptr<AssignPatternReader> assignPatternReader = pkbReaderManager->getAssignPatternReader();
//        std::shared_ptr<AssignWriter> assignWriter = pkbWriterManager->getAssignWriter();
//
//        statementWriter->insertStatement(1);
//        statementWriter->insertStatement(2);
...
//        assignPatternWriter->addAssignPattern(2, "z", "'y''2''+'");
//        assignPatternWriter->addAssignPattern(3, "x", "'3''z''+'");
//        assignPatternWriter->addAssignPattern(4, "w", "'z'");
//        assignWriter->insertAssign(1);
//        assignWriter->insertAssign(2);
//        assignWriter->insertAssign(3);
