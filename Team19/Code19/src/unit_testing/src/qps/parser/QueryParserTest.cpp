...
TEST_CASE("src/qps/parser/QueryParser/5") {
    //Select r such that Uses(r, 1)
...
TEST_CASE("src/qps/parser/QueryParser/6") {
    //Select r such that Uses(r, 1)
...
TEST_CASE("src/qps/parser/QueryParser/7") {
    //Select r such that Uses(r, 1)
...
TEST_CASE("src/qps/parser/QueryParser/8") {
    //Select r such that Uses(r, 1)
...
TEST_CASE("src/qps/parser/QueryParser/9") {
    //Select r such that Uses(r, 1)
...
TEST_CASE("src/qps/parser/QueryParser/10") {
    //Select r such that Uses(r, 1)
    SECTION("QueryParser correctly parses while Pattern with var syn and wildcards") {
        // Manually create the vector of tokens for the query
        std::vector<Token> tokens = {
...
TEST_CASE("src/qps/parser/QueryParser/11") {
    //Select r such that Uses(r, 1)
...
TEST_CASE("src/qps/parser/QueryParser/12") {
    //Select r such that Uses(r, 1)
...
TEST_CASE("src/qps/parser/QueryParser/13") {
    //Select r such that Uses(r, 1)
...
TEST_CASE("src/qps/parser/QueryParser/14") {
    //Select r such that Uses(r, 1)
