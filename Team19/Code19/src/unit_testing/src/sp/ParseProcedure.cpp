...
TEST_CASE("Procedure parsing throws an error for missing closing curly brace", "[parseStmtLst]") {
...
TEST_CASE("Procedure parsing throws an error for missing curly braces", "[parseStmtLst]") {
