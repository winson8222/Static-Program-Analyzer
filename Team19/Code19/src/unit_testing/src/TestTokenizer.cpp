...
TEST_CASE("Modifies with valid statement and variable") {
    ...
    REQUIRE(tokens[6].getType() == TokenType::ClauseKeyword && tokens[6].getValue() == "Select");
    REQUIRE(tokens[7].getType() == TokenType::IDENT && tokens[7].getValue() == "s");
    REQUIRE(tokens[8].getType() == TokenType::ClauseKeyword && tokens[8].getValue() == "such");
    REQUIRE(tokens[9].getType() == TokenType::ClauseKeyword && tokens[9].getValue() == "that");
    REQUIRE(tokens[10].getType() == TokenType::RelRef && tokens[10].getValue() == "Modifies");
...
TEST_CASE("Modifies with quoted variable") {
    ...
    REQUIRE(tokens[1].getType() == TokenType::IDENT && tokens[1].getValue() == "s");
    REQUIRE(tokens[2].getType() == TokenType::Semicolon && tokens[2].getValue() == ";");
    REQUIRE(tokens[3].getType() == TokenType::ClauseKeyword && tokens[3].getValue() == "Select");
    REQUIRE(tokens[4].getType() == TokenType::IDENT && tokens[4].getValue() == "s");
    REQUIRE(tokens[5].getType() == TokenType::ClauseKeyword && tokens[5].getValue() == "such");
    REQUIRE(tokens[6].getType() == TokenType::ClauseKeyword && tokens[6].getValue() == "that");
    REQUIRE(tokens[7].getType() == TokenType::RelRef && tokens[7].getValue() == "Modifies");
...
TEST_CASE("Pattern with variable and constant") {
    ...
    REQUIRE(tokens[5].getType() == TokenType::ClauseKeyword && tokens[5].getValue() == "pattern");
